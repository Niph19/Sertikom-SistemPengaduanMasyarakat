    ...
    <div class="max-w-sm w-full text-white space-y-5">
        ...
        @csrf
            ...
            <div class="mt-3">
                ...
                <input type="email" id="email" name="email" placeholder="masyarakat@gmail.com"
                    class="w-full mt-2 px-3 py-2 text-white bg-transparent outline-none border focus:border-red-600 shadow-sm rounded-lg" />
            </div>
            ...
            <div x-data="{ showPassword: false }" class="relative mt-3">
                ...
                <input :type="showPassword ? 'text' : 'password'" placeholder="Confirm your password" id="password_confirmation" name="password_confirmation"
                    class="w-full mt-2 px-3 py-2 text-white bg-transparent outline-none border focus:border-red-600 shadow-sm rounded-lg" />
                <span @click="showPassword = !showPassword"
                    class="absolute top-13 right-4 z-30 -translate-y-1/2 cursor-pointer text-white dark:text-white">
                    <svg x-show="!showPassword" class="fill-current" width="20" height="20" viewBox="0 0 20 20"
            ...
            <button action="{{ route('register') }}" type="submit"
                class="w-full px-4 py-2 mt-5     text-white font-medium bg-blue-600 hover:bg-blue-500 active:bg-blue-600 rounded-lg duration-150">
                Register
            </button>
        </form>
        <p class="text-center">
