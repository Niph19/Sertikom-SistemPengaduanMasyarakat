    ...
    <div class="grid grid-cols-1 gap-6 xl:grid-cols-2">
        <x-common.component-card title="Default Inputs">
            ...
            <div>
                ...
                <input type="text" name="judul_pengaduan" id="judul_pengaduan" placeholder="Masukkan judul pengaduan"
                ...
                <div class="flex items-center justify-center w-full">
                    <label for="foto_pengaduan"
                        ...
                        <div class="flex flex-col items-center justify-center text-body pt-5 pb-6">
                            ...
                            <p class="mb-2 text-sm" id="file-preview-text"><span class="font-semibold text-gray-700 dark:text-gray-200">Klik untuk mengunggah</span></p>
            ...
            <div>
                <button type="submit" class="mt-5 bottom-full bg-blue-500 text-white bg-brand box-border border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-md w-full rounded-md px-4 py-2.5 focus:outline-none">Submit</button>
            </div>
