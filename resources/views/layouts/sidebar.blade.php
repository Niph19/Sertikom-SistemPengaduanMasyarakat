...
<aside id="sidebar"
    ...
    <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
        src="/images/logo_kota_bogor.png" alt="Logo" 
        width="44" height="44"
        class="shrink-0"/>
    <div x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
        class="flex flex-col leading-tight">
        <h1 class="text-white/90 text-sm font-semibold leading-snug">Sistem Pengaduan Masyarakat</h1>
        <h2 class="text-gray-400 text-xs font-normal">Kota Bogor</h2>
    </div>
    <img x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen"
                src="/images/logo_kota_bogor.png" alt="Logo" width="32" height="32" />
</div>
